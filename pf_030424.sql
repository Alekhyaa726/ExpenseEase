...
INSERT INTO `Expense` VALUES (1,1000,'Food','2024-03-16','Debit','hello'),(1,100,'Food','2024-03-14','UPI','prabhav'),(2,65002,'Food','2024-03-13','Debit','hello'),(2,100,'Food','2024-03-14','NetBanking','prabhav'),(3,1200,'Food','2024-03-15','NetBanking','hello'),(3,123,'Beverages','2024-03-14','Debit','prabhav'),(4,200,'Beverages','2024-03-13','Cash','hello'),(4,200,'Education','2024-03-07','Cash','prabhav'),(5,569,'Food','2024-03-13','Credit','hello'),(5,1000,'Food','2024-03-09','Debit','prabhav'),(6,100,'Food','2024-04-11','Cash','hello'),(7,100,'Food','2024-04-11','Cash','hello');
...
INSERT INTO `Loan` VALUES (1,1000,12,1000,'2024-03-07','2024-03-14','Personal','2024-03-26','hello'),(1,100000,15,20000,'2024-03-29','2022-02-12','Home','2024-03-13','prabhav'),(2,12000,13,7500,'2024-06-06','2024-02-01','Car','2024-04-11','hello'),(2,10000,12,2000,'2024-04-19','2024-01-17','Home','2024-04-02','prabhav'),(3,10000,13,2000,'2024-04-19','2024-01-17','Home','2024-04-02','prabhav');
...
INSERT INTO `Notification` VALUES (1,'ADD EXPENSE','hello','Added an expense'),(2,'ADD EXPENSE','hello','Added an expense of amount 200'),(3,'ADD LOAN','hello','Added a loan of amount 1000 at an interest rate of 12%'),(4,'ADD EXPENSE','hello','Added an expense of amount 569'),(5,'ADD EXPENSE','hello','Added an expense of amount 100'),(6,'ADD EXPENSE','hello','Added an expense of amount 100'),(7,'ADD LOAN','hello','Added a loan of amount 12000 at an interest rate of 13%'),(10,'ADD LOAN','prabhav','Added a loan of amount 10000 at an interest rate of 12%'),(11,'ADD LOAN','prabhav','Added a loan of amount 10000 at an interest rate of 13%');
...
-- Dump completed on 2024-04-03 22:09:56
